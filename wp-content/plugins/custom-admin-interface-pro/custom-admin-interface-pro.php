...
/*
*		Plugin Name: Custom Admin Interface 
*		Plugin URI: 
...
{
    wp_enqueue_style('my-admin-theme', plugins_url('custom/css/style-admin.css', __FILE__), array(), custom_admin_code_pro_version(), null);
    ...
    // wp_enqueue_style('my-admin-theme', plugins_url('custom/css/style-admin.css', __FILE__), array(), filemtime(plugins_url('custom/css/style-admin.css')), null);

}
add_action('admin_enqueue_scripts', 'my_admin_theme_style');
add_action('login_enqueue_scripts', 'my_admin_theme_style');

// include('custom/custom_font.php'); // Don's working
// //////////////////////////////////////////////////////////////////////////////////////////////////////
//Turn off plugin Update
...
$plugin_update_checker_custom_admin_interface_pro->addFilter(
    'request_info_result',
    'filter_puc_request_info_result_slug_custom_admin_interface_pro',
    10,
    2
);
